...
% Randomly generate noise 100 times and run VITTC for different settings
%
% Reference
% 
...
for iter = 1:100
    ...
    threshold = 100;
    [A_completed,Gcore,Lambda,Tau,rse,rank_estimated] = VITTC(A_raw,A_observed,S,'svdinit',max_iter,threshold);
